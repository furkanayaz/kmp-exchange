...
object CallUtil {
    ...
    fun ApplicationConfig.getFinanceServer(): SPXServer {
    ...
    suspend inline fun <reified T> RoutingCall.require(): T {
        ...
        val body = try {
            this.receiveNullable<T>() ?: throw FinanceExceptions.MissingBodyException()
        } catch (_: BadRequestException) {
            throw FinanceExceptions.MissingFieldException()
        }
